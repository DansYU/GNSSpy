...
"""
  ...
  Copyright (C) <2009>  Bartek Gorny <bartek@gorny.edu.pl>
...
if __name__ == '__main__':
    ...
    brussels = ((5, 17, 30), (50, 20, 30))

    print 'Distance warsaw-cracow   = %s km' % points2distance(warsaw, cracow)
    print 'Distance warsaw-brussels = %s km' % points2distance(warsaw, brussels)
    print 'Distance brussels-cracow = %s km' % points2distance(brussels, cracow)
